    ...
    <div className="h-[calc(100vh-12rem)] flex flex-col p-12 bg-card rounded-3xl shadow-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 flex-1">
        <div className="bg-gradient-to-br from-[rgb(var(--onus-dark-blue-rgb))]/5 to-transparent p-8 rounded-2xl border border-border">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl text-[rgb(var(--onus-dark-blue-rgb))] font-semibold">Plataforma TecnolÃ³gica</h2>
          </div>
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-foreground/70">Algoritmos de machine learning para optimizaciÃ³n continua</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold mb-1">TecnologÃ­a Propia</h4>
                <p className="text-foreground/70">Desarrollo interno para mÃ¡xima flexibilidad</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[rgb(var(--onus-turquoise-rgb))]/10 to-transparent p-8 rounded-2xl border-2 border-[rgb(var(--onus-turquoise-rgb))]/30">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/50 dark:bg-black/20 p-5 rounded-xl">
              <h4 className="font-semibold mb-2">AsignaciÃ³n Ãgil 24/7</h4>
            ...
            <div className="bg-white/50 dark:bg-black/20 p-5 rounded-xl">
              ...
              <p className="text-foreground/70">Visibilidad completa del envÃ­o en tiempo real</p>
            </div>
            ...
            <div className="bg-white/50 dark:bg-black/20 p-5 rounded-xl flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-foreground/70 text-sm">Para mÃ¡xima fiabilidad</p>
              </div>
            </div>
      ...
      <div className="mt-8 bg-[rgb(var(--onus-dark-blue-rgb))] p-6 rounded-2xl text-center">
        <p className="text-white text-lg">
          <strong className="text-[rgb(var(--onus-turquoise-rgb))]">Resultado:</strong> TecnologÃ­a que se adapta a tu operativa, no al revÃ©s
        </p>
      </div>
    </div>
  );
