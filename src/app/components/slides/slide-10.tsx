...
import { Target, Thermometer, Calendar, DollarSign, Shield } from "lucide-react";
    ...
    <div className="w-full h-full flex items-center justify-center p-12">
      <div className="max-w-6xl w-full">
        ...
        <motion.div
          ...
          className="mt-12 bg-[rgb(var(--onus-turquoise-rgb))]/15 backdrop-blur-md border border-[rgb(var(--onus-turquoise-rgb))]/30 rounded-2xl p-8"
        >
